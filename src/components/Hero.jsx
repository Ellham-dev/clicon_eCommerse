import { ArrowRight, Dot, DotIcon } from 'lucide-react'
                    ...
                    <div className="flex items-center gap-x-6">
                        ...
                        <div className="bg-[#F2F4F5] flex items-center gap-x-9 p-[56px] w-[872px] relative">
                            ...
                            <div className="max-w-[356px]">
                                ...
                                <div className="flex items-center justify-center gap-x-2 bg-[#FA8232] px-6 py-1.5 rounded-lg max-w-[192px] text-white cursor-pointer">
                            ...
                            <div className="flex items-center  absolute left-14 bottom-14">
                                <Dot size={28} />
                                <Dot size={28} color={'#ADB7BC'} />
                                <Dot size={28} color={'#ADB7BC'} />
                            </div>
                        </div>
                        {/* Hero_second_par */}
